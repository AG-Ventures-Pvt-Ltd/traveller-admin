import { USER_STATUS, PLAN_CONFIG, ROLE_CONFIG } from '../constants.js'
import { formatCurrency,formatDate } from '../../../utils/utils.js'
import { CheckCircle, User, Ban } from 'lucide-react';
import {
  Card,
  Space,
  Tag,
...
export const UserDetailModal = ({selectedUser,modalVisible,setModalVisible}) => {
    const STATUS_CONFIG = {
  [USER_STATUS.ACTIVE]: {
    color: 'success',
    text: 'Active',
              ...
              <Card size="small" style={{ background: 'rgba(255, 255, 255, 0.05)' }}>
                <Space direction="vertical" style={{ width: '100%' }}>
                  ...
                  <div className='flex gap-4'>
                    <Badge
                      status={STATUS_CONFIG[selectedUser.status].color}
