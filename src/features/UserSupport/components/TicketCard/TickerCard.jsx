...
export const TicketCard = ({ ticket, handleTicketClick }) => {
  ...
  >
    <div className="flex justify-between items-start mb-3">
      ...
      <Space direction="vertical" align="end" size={4}>
        <Badge 
          status={STATUS_CONFIG[ticket?.status].color} 
          text={STATUS_CONFIG[ticket?.status].text}
          style={{ color: '#fff' }}
        />
        <Tag color={PRIORITY_LEVELS[ticket?.priority.toUpperCase()].color} size="small">
