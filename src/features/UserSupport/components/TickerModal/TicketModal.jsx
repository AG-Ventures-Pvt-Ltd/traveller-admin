...
import { PRIORITY_LEVELS, STATUS_CONFIG } from '../../constants';
import { Modal, Space, Badge, Tag, Card, Row, Col, Divider, Typography, Avatar, Input, Button, Image } from 'antd';
import { Send, Eye } from 'lucide-react';

export const TicketModal = ({ handleSendReply, modalVisible, setModalVisible, selectedTicket, replyText, setReplyText }) => {
